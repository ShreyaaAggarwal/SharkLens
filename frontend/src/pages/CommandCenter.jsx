...
const SHARKS = [
  ...
  {
    id: 'vc', initials: 'SV', name: 'Priya Sharma',
  ...
  {
    id: 'angel', initials: 'IA', name: 'Sunita Agarwal',
...

  {
    ...
    color:'var(--vc)', mute:'var(--vc-mute)', ring:'var(--vc-ring)',
    tags:['PHILOSOPHER','CONTRARIAN','LONG-TERM'],
    desc:'Questions conventional wisdom. Asks about moats, not just revenue. Built Zerodha.',
    label:'DEEP',
  },
  {
    ...
    desc:'Obsessed with brand and consumer emotion. Will grill your product decisions.',
    label:'BRAND',
  },
  {
    id:'aman', initials:'AG', name:'Aman Gupta',
    color:'var(--cuban)', mute:'var(--cuban-mute)', ring:'var(--cuban-ring)',
    tags:['D2C','MARKETING','DISTRIBUTION'],
    desc:'Built boAt to ₹3,000Cr. Challenges your GTM and distribution strategy.',
    label:'D2C',
  },
]
